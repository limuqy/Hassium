 ...
 *   <li>{@code MC_1_20_2 <= MC_VER < MC_1_20_5}（段 B，1.20.2/1.20.3）：
 *       {@code new ServerData(String,String,ServerData.Type)} + 同 5 参数 {@code startConnecting}。</li>
 *   <li>{@code MC_VER >= MC_1_20_5}（段 C 及以后，1.20.5~1.21.11）：
 ...
 * </ul>
 * 八个段外锚点的 {@code ServerData.Type} 数量、各段 {@code Minecraft.disconnect} API 等差异不影响此 launcher，
 * 因为它只依赖 {@code ServerData.Type.OTHER} 这一枚举常量、{@code ServerAddress(String,int)} 构造、
 * 及上述两处 vanilla 入口签名。
 */
