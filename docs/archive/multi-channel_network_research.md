> 归档：历史研究文档（TCP PoC 已退役，被 UDP/KCP 取代）（2026-08-09）
---
...
todos:
  ...
  - id: poc-dual-port
    ...
    status: completed
    note: 2026-07-25/26 在 1.20.1 fabric 落地；见 docs/archive/superpowers/specs/2026-07-25-multi-channel-dataplane-poc-design.md 与 docs/archive/superpowers/plans/2026-07-25-multi-channel-dataplane-poc.md；端到端冒烟拿到 DATAPLANE_PASS（commit 6aa36f4）
  - id: handshake-config
