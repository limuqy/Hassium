> 归档：历史 superpowers 状态记录（计划已归档）（2026-08-09）
# 统一端点模型实施 — 现状盘点与暂停决定
...
Plan 路径: `docs/archive/superpowers/plans/2026-07-27-unified-endpoint-model-and-nginx-smoke.md`
...
- Plan: `docs/archive/superpowers/plans/2026-07-27-unified-endpoint-model-and-nginx-smoke.md`(Task 清单在此)
- Spec: `docs/archive/superpowers/specs/2026-07-27-unified-endpoint-model-and-nginx-smoke-design.md`
- Parent 早期 plan: `docs/archive/superpowers/plans/2026-07-26-udp-dataplane-control-failover.md`
- Rollout plan: `docs/archive/superpowers/plans/2026-07-26-udp-dataplane-rollout.md`
