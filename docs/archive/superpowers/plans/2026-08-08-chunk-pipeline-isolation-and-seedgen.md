...
7. 验收：
   ...
   - 1.20.1 fabric Phase R 冒烟：R1/R2 命中率区间、Disconnect dump 计数、OVD 行为与改造前一致（对照 `docs/archive/smoke-blackchunk-handoff-20260808.md` 记录的基线）。
...
- [`docs/chunk-cache.md`](../../../chunk-cache.md) — 缓存/hash/sectionDelta 设施（磁盘 NBT 细节见其 §11）
...
- `docs/archive/superpowers/plans/2026-07-26-udp-dataplane-rollout.md` — 计划格式与 Global Constraints 惯例
