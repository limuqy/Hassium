...
> 日期：2026-09-14
> 依据：`docs/code-review-2026-09-13.md`（2026-09-14 核查修订）§八 处理优先级表 + 四路核查结论；`pre-2.0.0-must-fix` REQ/TASKS 拍板
...
3. **T9 文档本身**：`docs/code-review-2026-09-13.md` 为只读审查快照，不改原文；本清单是延后项的活文档。
