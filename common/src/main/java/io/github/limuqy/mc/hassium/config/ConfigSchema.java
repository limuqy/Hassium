...
public final class ConfigSchema {
    ...
    public static final ConfigKey<Integer> CACHE_MAX_CHUNKS_PER_FRAME = integer("clientCache.maxChunksPerFrame", ConfigScope.CLIENT, 12, 1, 512, "每帧应用缓存区块硬顶");
    ...
    public static final ConfigKey<Boolean> CACHE_LIGHT_SYNC_MODE = bool("clientCache.lightSyncMode", ConfigScope.CLIENT, false, "是否启用光照重算同步模式（双帧缓冲：本帧收集无光照区块，下一帧尾阻塞全部重算落地，黑块窗口≤1帧；默认 false=异步预算消费；与 parallelLightEngineEnabled 同开时本项优先）");
